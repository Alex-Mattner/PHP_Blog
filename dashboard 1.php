	...
	<body>
		...
		<form action="" method="POST" enctype="multipart/form-data">
			...
			<fieldset>
				<legend>Neuer Blog-Eintrag</legend>
					...
					<input type="text" name="heading" placeholder="Überschrift" value="<?php echo $heading ?>">
					...
					<textarea name="inputTextarea" placeholder="Bitte geben Sie hier ihren Text ein..."><?php echo $inputTextarea ?>textarea>
					<span class="marker">*</span>
					<br>
		...
		<form action="" method="POST">
			...
			<fieldset>
				...
				<input type="text" name="inputText" placeholder="Kategorie..." value="<?php echo $newCategory ?>">
					<br>
